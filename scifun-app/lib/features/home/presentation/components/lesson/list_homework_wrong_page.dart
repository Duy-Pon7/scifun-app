...
class ListHomeworkWrongPage extends StatelessWidget {
  final List<QuestionEntity> questions;
  final List<UserAnswerEntity> resultAnswers;

  const ListHomeworkWrongPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final wrongQuestions = questions.where((q) {
      ...
      return !isCorrectAnswer(q, selectedIds); // Đảo ngược điều kiện
    }).toList();

    if (wrongQuestions.isEmpty) {
      return Center(child: Text("Không có câu nào làm sai."));
    }
    return ListView(
      ...
      children: [
        Row(
          ...
          children: [
            Text(
              "Tổng số câu sai: ${wrongQuestions.length}",
        ...
        ...List.generate(wrongQuestions.length, (questionIndex) {
          final question = wrongQuestions[questionIndex];
