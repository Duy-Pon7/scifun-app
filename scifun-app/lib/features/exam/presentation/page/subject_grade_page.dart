...
import 'package:thilop10_3004/features/exam/presentation/page/test_detail_page.dart';
import 'package:thilop10_3004/features/exam/presentation/widget/card_subject_item.dart';
import 'package:thilop10_3004/features/home/presentation/cubit/quizz_cubit.dart';
import 'package:thilop10_3004/features/subject/presentation/cubit/subject_cubit.dart'; // <-- Đảm bảo import Cubit

class SubjectGradePage extends StatelessWidget {
  final int examId;
  const SubjectGradePage({super.key, required this.examId});
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CardSubjectItem(
                    ...
                    title: subject.name ?? '',
                    onTap: () {
                      print("Subject ID: ${subject.id} for exam $examId");
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BlocProvider(
                            create: (context) =>
                                QuizzCubit(sl(), sl(), sl(), sl()),
